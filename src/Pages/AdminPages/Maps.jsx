...
import MapsCreate from "../../Components/AdminComponents/Maps/MapsCreate";
import MapsDelete from "../../Components/AdminComponents/Maps/MapsDelete";
import MapsEdit from "../../Components/AdminComponents/Maps/MapsEdit";
    ...
    return (
        <div className="p-6 min-h-screen bg-gray-50">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <MapsCreate refresh={getLocations} />
            </div>
                    ...
                    {data.map((item) => (
                        <Card key={item.id} className="shadow-lg">
                            ...
                            <CardFooter className="pt-3 flex justify-between gap-2">
                                <MapsEdit data={item} refresh={getLocations} />
                                <MapsDelete id={item?.id} refresh={getLocations} />
                            </CardFooter>
                        </Card>
                    ))}
                </div>
